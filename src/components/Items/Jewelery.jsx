...
<div  style={{display:"flex",flexWrap:"wrap",gap:"10px",alignItems:"center",justifyContent:"center",marginTop:"30px"}}>
{
    men.map((e)=>{
        return(
            <div style={{width:"400px",height:"500px",padding:"20px",border:"1px solid black",textAlign:"center",boxShadow:"1px 5px 5px 0px black",backgroundColor:"whitesmoke",borderRadius:"10px"}}>
